...
# 2. Save compressed model with gzip + pickle
import pickle, gzip

with gzip.open("match_winner_model.pkl.gz", "wb") as f:
    pickle.dump(model, f)

# 3. Download compressed model
from google.colab import files
files.download("match_winner_model.pkl.gz")
