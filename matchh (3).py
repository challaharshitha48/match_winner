...
# Load Model Safely
# =========================
model_path = "match_winner_model_joblib.pkl"  # Make sure this file is uploaded in the same folder

if os.path.exists(model_path):
    model = joblib.load(model_path)
else:
    st.error("❌ Model file not found! Upload 'match_winner_model_joblib.pkl' to the repo.")
