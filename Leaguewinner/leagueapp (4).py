...
# 🔍 Debug: Check working directory & file presence
st.write("### 📂 Current Working Directory:", os.getcwd())
st.write("### 📄 Files present in this folder:", os.listdir())

# ✅ Check if model file exists
if not os.path.exists("league_winner_model.pkl"):
    st.error("❌ 'league_winner_model.pkl' not found. Please upload it to the same folder as app.py.")
    st.stop()
else:
